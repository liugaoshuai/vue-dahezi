        ...
        <div class="box">
            <div class="box-header tac pd10">
                <div class="box-header-btn l">
                    <a href="tel:10086"
                       class="img imgurl20"></a>
                </div>
                <div class="box-header-btn r fs12">
                    <a href="javascript"
                       class="img imgurl21"
                       @click="goPayMonthCard"></a>
                </div>
            ...
            <div class="box-footer tac pdb10"
                ...
                <p class="fs16 mgt10">
                    <img src="../assets/icon_Storelocation.png"
                         alt=""
                         style="width: 2.2rem;">{{orderAddress}}</p>
...
export default {
    ...
    mounted: function () {
        ...
        var inttwo = setInterval(function () {
            ...
            var self = this,
                ...
                succeed = function (res) {
                    ...
                    if (res.data.data.washStatus == 2) {
                        ...
                        self.time = res.data.data.leftTime;
