        ...
        <div class="box">
            <div class="box-header tac pd10">
                <div class="box-header-btn l">
                    <img src="../assets/icon_Customerservice.png"
                         alt=""
                         style="width: 2rem;" @click="call">
                </div>
                <div class="box-header-btn r fs12">
                    <img src="../assets/icon_buycard.png"
                         alt=""
                         style="width: 2rem;">
                </div>
            ...
            <div class="box-footer tac mgt20 pdb10"
                 v-show="time == 0">
                <div class="pdtb20"><img src="../assets/logo.png"
                         alt=""
                         style="width: 9.2rem;"></div>
                <p class="fs16 mgt10"><img src="../assets/icon_Storelocation.png"
                         alt=""
                         style="width: 2.2rem;">{{address}}</p>
                <a class="common-btn mgt10"
                   href="javascript:void(0)"
                   @click="$mint.MessageBox('洗车已完成，请缓慢驶离。');">祝您一路顺风，下周见！</a>
                <p class="fs12 mgt10">2017.11.16 12:38</p>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        getOrderMsg: function () {
            var self = this,
                url = 'http://test.yixiutong.cn/cwtest/userinfo.json',
                params = {
                },
                succeed = function (res) {
                    self.address = res.data.data.store.address
                };
